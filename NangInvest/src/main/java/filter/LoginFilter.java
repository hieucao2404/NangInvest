...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String roleFromCookie = CookieUtil.getCookieValue(req, "role");
        ...
        //either can provide role
        String role = (user != null) ? user.getRole().toString() : roleFromCookie;

        String uri = req.getRequestURI();

        //block if role doesn't match the path
        if (uri.contains("/admin/") && !"ADMIN".equals(role)) {
            res.sendRedirect(req.getContextPath() + "/public/homepage.jsp?unauthorized=true");
            return;
        }
