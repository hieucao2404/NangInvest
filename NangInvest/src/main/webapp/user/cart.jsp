...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <c:if test="${param.error == 'no_chargeable_items'}">
                <div class="alert alert-warning">No chargeable items in your cart.</div>
            </c:if>
            <c:if test="${param.error == 'checkout_failed'}">
                <div class="alert alert-danger">Checkout failed. Please try again later.</div>
            </c:if>
                        ...
                        <c:forEach var="item" items="${cartItems}">
                            <div class="cart-item">
                                ...
                                <div class="item-actions">
                                    <button class="btn btn-danger btn-sm" onclick="removeItem('${item.cartItem.cartId}')">
                                        Remove
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="cart-summary">
                        <div class="summary-content">
                            ...
                            <div class="cart-actions">
                                <form method="POST" action="${pageContext.request.contextPath}/user/cart" onsubmit="console.log('Checkout form submitted');">
                                ...
                                <a href="${pageContext.request.contextPath}/courses" class="btn btn-outline-primary btn-block">
                                    Continue Shopping
                                </a>
                            </div>
                        </div>
